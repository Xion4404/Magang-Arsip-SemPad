...
<head>
    ...
    <title>Penghargaan - Sistem Informasi e-Arsip PT Semen Padang</title>
...
<body class="bg-white">
            ...
            <div class="container mx-auto px-6 pt-20">
                <div class="max-w-2xl text-white">
                    <h1 class="text-4xl md:text-5xl font-bold leading-tight mb-2 drop-shadow-lg">
                     ...
                     <p class="text-xl font-light">Penghargaan</p>
                </div>
            </div>
        </div>
    </div>
    
    <!-- Title & First Section with BG -->
    <div class="w-full relative" style="background-image: url('{{ asset('images/BG_supergrafis.png') }}'); background-size: cover; background-position: center;">
        <div class="absolute inset-0 bg-white/50"></div> <!-- Optional overlay for readability if needed, remove if not desired -->
        
        <!-- Title Section -->
        <div class="container mx-auto px-6 py-12 text-center relative z-10">
            <h2 class="text-3xl font-bold text-gray-800">Penghargaan & Pencapaian Kearsipan</h2>
        </div>

        <!-- 1. 2016-2026 (Transparent BG) - Image Left, Text Right -->
    ...
    <div class="w-full">
        ...
        <!-- 2. 2024 MOWCAP (BLACK) - Text Left, Image Right -->
        ...
        <!-- 3. 2024 5R (WHITE) - Image Left, Text Right -->
        ...
        <!-- 4. 2023 Cagar Budaya (RED) - Text Left, Image Right -->
        ...
        <!-- 5. 2023 Memori Kolektif (WHITE) - Image Left, Text Right -->
        ...
        <!-- 6. 2022 (BLACK) - Text Left, Image Right -->
        <div class="w-full bg-black py-16 px-6">
            <div class="container mx-auto flex flex-col md:flex-row items-center gap-12 max-w-7xl text-white">
                 <div class="w-full md:w-1/2 order-1 text-right space-y-4">
        ...
        <!-- 7. 2017 (WHITE) - Image Left, Text Right -->
        <div class="w-full bg-white py-16 px-6 relative overflow-hidden">
            <div class="container mx-auto flex flex-col md:flex-row items-center gap-12 max-w-7xl">
                 <div class="w-full md:w-1/2 order-2 md:order-1">
        ...
        <!-- 8. 2016 (RED) - Text Left, Image Right -->
        <div class="w-full bg-[#E92027] py-16 px-6">
            <div class="container mx-auto flex flex-col md:flex-row items-center gap-12 max-w-7xl text-white">
                 <div class="w-full md:w-1/2 order-1 text-right space-y-4">
