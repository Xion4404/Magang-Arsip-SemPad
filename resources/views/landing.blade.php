...
<body class="bg-white">
    ...
    <!-- Navigation -->
    <!-- Navigation -->
    <nav x-data="{ isScrolled: false }" @scroll.window="isScrolled = (window.pageYOffset > 50)"
        :class="isScrolled ? 'bg-white shadow-md py-6' : 'bg-transparent py-4'"
        class="fixed top-0 left-0 w-full z-50 transition-all duration-300">
        <div class="container mx-auto px-6 flex justify-between items-center">
            <div class="flex items-center gap-3">
                <img :src="isScrolled ? '{{ asset('images/sp-black.png') }}' : '{{ asset('images/sp-white.png') }}'"
                    alt="Logo Semen Padang"
                    class="h-20 drop-shadow-lg filter brightness-100 rounded px-2 py-1 transition-all duration-300">
            </div>
    ...
    <div x-data="{ 
        ...
        }" x-init="autoplay()" class="relative h-screen w-full overflow-hidden">

        <!-- Slides -->
        <template x-for="(slide, index) in slides" :key="index">
            <div x-show="activeSlide === index" x-transition:enter="transition transform duration-1000"
                x-transition:enter-start="opacity-0 scale-105" x-transition:enter-end="opacity-100 scale-100"
                x-transition:leave="transition transform duration-1000" x-transition:leave-start="opacity-100 scale-100"
        ...
        <div class="absolute inset-0 flex items-center z-20 pointer-events-none">
            <div class="container mx-auto px-6 pt-20 pointer-events-auto">
                <div class="max-w-2xl text-white">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="{{ route('login') }}"
                            class="px-8 py-4 bg-[#b91c1c] hover:bg-[#991b1b] text-white font-bold rounded-lg transition transform hover:-translate-y-1 shadow-lg text-center">
                            Login
                        </a>
                        <a href="#tentang"
                            class="px-8 py-4 bg-white hover:bg-gray-100 text-[#b91c1c] font-bold rounded-lg transition transform hover:-translate-y-1 shadow-lg text-center">
    ...
    <section id="tentang" class="py-20 bg-cover bg-center"
        style="background-image: url('{{ asset('images/white-bg.jpg') }}');">
        <div class="container mx-auto px-12">
            <div
                class="bg-white rounded-3xl shadow-xl p-8 md:p-12 max-w-6xl mx-auto transform transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl border border-transparent hover:border-red-100">
                <div class="flex flex-col md:flex-row gap-12 items-center">
                    <!-- Image Section -->
                    <div class="w-full md:w-1/3">
                        <div class="aspect-square rounded-2xl shadow-xl overflow-hidden group">
                            <img src="{{ asset('images/hp 6.jpeg') }}" alt="Tentang Semen Padang"
                    ...
                    <div class="w-full md:w-2/3">
                        ...
                        <p class="text-gray-600 mb-6 leading-relaxed text-lg">
                            Kearsipan di PT Semen Padang merupakan bagian penting dalam mendukung tertib administrasi
                            dan kelancaran operasional perusahaan. Setiap arsip dikelola sebagai sumber informasi yang
                            memiliki nilai guna bagi perusahaan, baik sebagai bukti kegiatan, bahan pengambilan
                            keputusan, maupun sebagai bentuk pertanggungjawaban organisasi.
                        </p>
                        <p class="text-gray-600 mb-6 leading-relaxed text-lg">
                            Pengelolaan kearsipan di PT Semen Padang dilaksanakan secara terkoordinasi oleh Unit Sistem
                            Manajemen dengan mengedepankan keteraturan, keamanan, dan kemudahan akses sesuai kebutuhan
                            kerja. Melalui pengelolaan arsip yang baik, perusahaan berupaya menjaga keberlangsungan
                            informasi serta mendukung penerapan tata kelola perusahaan yang efektif dan berkelanjutan.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="py-20 relative overflow-hidden bg-cover bg-center bg-fixed"
        style="background-image: url('{{ asset('images/hp 5.jpeg') }}');">
        ...
        <div class="container mx-auto px-6 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                ...
                <div
                    class="bg-white/10 backdrop-blur-sm border border-white/20 p-8 rounded-2xl text-center text-white hover:transform hover:-translate-y-2 transition duration-300">
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="group relative overflow-hidden rounded-2xl shadow-xl h-72 cursor-pointer">
                    <img src="{{ asset('images/hp 4.jpeg') }}" alt="Dokumentasi 1"
                        class="w-full h-full object-cover transform group-hover:scale-110 transition duration-500">
                    <div
                        class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition duration-300 flex items-end justify-center pb-6">
                        <span class="text-white font-medium tracking-wide">Kegiatan Arsip</span>
                    </div>
                </div>
                <!-- Image 2 -->
                <div class="group relative overflow-hidden rounded-2xl shadow-xl h-72 cursor-pointer">
                    <img src="{{ asset('images/hp 7.jpeg') }}" alt="Dokumentasi 2"
                        class="w-full h-full object-cover transform group-hover:scale-110 transition duration-500">
                    <div
                        class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition duration-300 flex items-end justify-center pb-6">
                ...
                <!-- Image 3 -->
                <div class="group relative overflow-hidden rounded-2xl shadow-xl h-72 cursor-pointer">
                    <img src="{{ asset('images/hp 5.jpeg') }}" alt="Dokumentasi 3"
                        class="w-full h-full object-cover transform group-hover:scale-110 transition duration-500">
                    <div
                        class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition duration-300 flex items-end justify-center pb-6">
    ...
    <section id="fitur" class="relative bg-white">
        ...
        <div class="absolute top-0 left-0 w-full h-[300px] bg-[#7f1d1d] overflow-hidden">
            ...
            <div class="absolute inset-0"
                style="background: radial-gradient(circle at 50% 0%, #ef4444 0%, #991b1b 60%, #7f1d1d 100%);"></div>
        </div>
        ...
        <div class="container mx-auto px-6 relative z-10 pt-15 pb-20">
            <div class="text-center mb-16">
                ...
                <p class="text-red-100 max-w-2xl mx-auto">
                    Sistem E-Arsip PT Semen Padang adalah solusi digital terintegrasi yang dikembangkan khusus untuk
                    mengelola dokumen dan arsip secara efisien dan aman.
                </p>
                <p class="text-red-100 max-w-2xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
                ...
                <div class="bg-white p-8 rounded-2xl shadow-xl hover:-translate-y-2 transition-all duration-300 group">
                    <div
                        class="w-16 h-16 bg-red-50 rounded-full flex items-center justify-center mb-6 group-hover:bg-[#b91c1c] transition-colors duration-300">
                        <svg class="w-8 h-8 text-[#b91c1c] group-hover:text-white transition-colors duration-300"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                        </svg>
                    </div>
                    <h3 class="font-bold text-xl text-gray-800 mb-3 group-hover:text-[#b91c1c] transition-colors">
                        Dashboard</h3>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-xl hover:-translate-y-2 transition-all duration-300 group">
                    ...
                    <h3 class="font-bold text-xl text-gray-800 mb-3 group-hover:text-[#b91c1c] transition-colors">Arsip
                        Masuk</h3>
                    <p class="text-gray-500 text-sm leading-relaxed">
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">
                        Graha Irama, Lt. 11, Jl. H. R. Rasuna Said No. 1 & 2, RT.6/RW.4, Kuningan Timur, Kecamatan
                        Setiabudi, Kota Jakarta Selatan 12950, DKI Jakarta
                    </p>
                </div>
                <!-- Media Sosial -->
                <div>
                    ...
                    <div class="flex gap-4 mb-6">
                        <a href="#"
                            class="w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center text-gray-600 hover:bg-red-600 hover:text-white transition"><svg
            ...
            <div class="bg-[#dc2626] -mx-6 -mb-10 py-4 text-center">
                <p class="text-white text-sm">© {{ date('Y') }} PT Semen Padang. All Rights Reserved. e-Arsip System.
                </p>
            </div>
        </div>
    </footer>
