    ...
    <section id="fitur" class="relative bg-white">
        ...
        <div class="container mx-auto px-6 relative z-10 pt-15 pb-20">
            <div class="text-center mb-16">
                 <h2 class="text-4xl font-bold text-white mb-4">Fitur</h2>
                 <p class="text-red-100 max-w-2xl mx-auto">
                    Sistem Informasi Record Center adalah solusi digital terintegrasi yang dikembangkan khusus untuk mengelola kearsipan secara efisien dan aman.
                 </p>
                 <p class="text-red-100 max-w-2xl mx-auto">
