            ...
            <form action="{{ route('arsip-masuk.store') }}" method="POST">
                 ...
                 <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
                     ...
                     <div>
                         ...
                         <input type="text" name="nomor_berita_acara" required class="w-full bg-[#FFF5F5] border border-red-200 rounded-lg p-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#8B1A1A]" placeholder="Masukkan Nomor Berita Acara">
                     </div>
                     ...
                     <div>
                         ...
                         <input type="date" name="tanggal_terima" required class="w-full bg-[#FFF5F5] border border-red-200 rounded-lg p-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#8B1A1A]">
                     </div>

                     <!-- Jumlah Box Masuk -->
                     <div>
                         <label class="block text-gray-800 font-bold mb-2 text-sm">Jumlah Box Masuk</label>
                         <input type="number" name="jumlah_box_masuk" required class="w-full bg-[#FFF5F5] border border-red-200 rounded-lg p-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#8B1A1A]" placeholder="Contoh: 5">
                     </div>
                 </div>
