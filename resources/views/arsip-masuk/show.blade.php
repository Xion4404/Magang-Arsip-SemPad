<x-layout>
    <div class="max-w-7xl mx-auto my-10">
        <!-- Header Card -->
        <div class="bg-[#e92027] rounded-t-2xl shadow-lg relative overflow-hidden mb-6">
            ...
            <div class="p-8 relative z-10 text-white">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-[#e92027] mt-2 text-lg">{{ $arsipMasuk->unit_asal }}</p>
                    </div>
                    <div class="text-right">
                        <span class="bg-[#c41820] bg-opacity-50 border border-[#e92027] rounded-lg px-4 py-2 backdrop-blur-sm">
                            <span class="text-xs text-[#e92027] block uppercase tracking-wider">Nomor Berita Acara</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <!-- Tanggal Terima -->
            <div class="bg-white p-6 rounded-2xl shadow-md border border-red-100 hover:shadow-lg transition duration-300 flex items-center gap-5 group">
                <div class="w-16 h-16 bg-red-100 rounded-2xl flex items-center justify-center text-[#e92027] group-hover:bg-[#e92027] group-hover:text-white transition duration-300 shadow-sm">
        ...
        <div class="mt-8">
            <a href="{{ route('arsip-masuk.index') }}" class="inline-flex items-center text-gray-600 hover:text-[#a0131a] font-medium transition">
