...
<body class="bg-gray-50 font-sans text-gray-800">
    ...
    <div x-data="{ sidebarOpen: true }" class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden transition-all duration-300 relative">
            ...
            {{-- Header --}}
            <header class="bg-gradient-to-r from-red-900 to-red-700 px-6 py-4 flex justify-between items-center shadow-md z-10">
                <div class="flex items-center gap-4">
                    {{-- Toggle Sidebar Button --}}
                    <button @click="sidebarOpen = !sidebarOpen" class="text-white hover:bg-white/10 p-2 rounded-lg focus:outline-none transition">
