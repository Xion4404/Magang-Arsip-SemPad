...
>
    ...
    <nav class="flex-1 px-4 space-y-1 overflow-y-auto min-w-[16rem]">
        ...
        <a href="/arsip" class="flex items-center gap-3 px-4 py-3 {{ Request::is('arsip') || Request::is('arsip/*') ? 'bg-red-800 text-white shadow-md' : 'text-gray-600 hover:bg-red-50 hover:text-red-700' }} rounded-lg transition">
