<aside class="bg-white border-r border-gray-200 flex flex-col transition-all duration-300 ease-in-out"
    ...
    <div class="px-6 py-6 text-center min-w-[16rem]">
        <a href="{{ route('profile.edit') }}" class="block group cursor-pointer">
            <div
                class="w-20 h-20 mx-auto bg-red-100 rounded-full flex items-center justify-center text-red-600 mb-3 border-2 border-red-500 overflow-hidden group-hover:border-red-600 transition">
            ...
            <h3 class="font-bold text-red-700 text-sm group-hover:text-red-800 transition">
                {{ Auth::user()->nama ?? 'User' }}
            </h3>
            <p class="text-xs text-gray-500 mb-1">{{ Auth::user()->email ?? 'email@example.com' }}</p>
            <span class="text-[10px] text-red-500 font-semibold opacity-0 group-hover:opacity-100 transition">Klik untuk
                Edit Profile</span>
        </a>
    </div>
    ...
    <nav class="flex-1 px-4 space-y-1 overflow-y-auto min-w-[16rem]">
        ...
        <a href="/beranda"
            class="flex items-center gap-3 px-4 py-2.5 text-sm {{ Request::is('beranda') ? 'bg-red-800 text-white shadow-md' : 'text-gray-600 hover:bg-red-50 hover:text-red-700' }} rounded-lg transition">
        ...
        <a href="{{ route('arsip-masuk.index') }}"
            class="flex items-center gap-3 px-4 py-2.5 text-sm {{ Request::is('arsip-masuk*') ? 'bg-red-800 text-white shadow-md' : 'text-gray-600 hover:bg-red-50 hover:text-red-700' }} rounded-lg transition">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="/arsip"
            class="flex items-center gap-3 px-4 py-2.5 text-sm {{ Request::is('arsip') || Request::is('arsip/*') ? 'bg-red-800 text-white shadow-md' : 'text-gray-600 hover:bg-red-50 hover:text-red-700' }} rounded-lg transition">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="/peminjaman"
            class="flex items-center gap-3 px-4 py-2.5 text-sm {{ Request::is('peminjaman*') ? 'bg-red-800 text-white shadow-md' : 'text-gray-600 hover:bg-red-50 hover:text-red-700' }} rounded-lg transition">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="/monitoring"
            class="flex items-center gap-3 px-4 py-2.5 text-sm {{ Request::is('monitoring*') ? 'bg-red-800 text-white shadow-md' : 'text-gray-600 hover:bg-red-50 hover:text-red-700' }} rounded-lg transition">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
